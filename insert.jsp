    ...
    <div class="col-sm-8 text-left"> 
      ...
      <%
       ...
       if(output.isEmpty()){
	       ...
	       String sqlid = "select MAX(id) as max from Cantante;";
	       ResultSet rs = stmt.executeQuery(sqlid);
           rs.next();
	       int id = rs.getInt("max");
			

	       String sql = "ISERT INTO Cantante VALUES(?,?,?,?,?);";
	       ...
	       pstmt.setString(5, request.getParameter("luogo"));
	       pstmt.executeUpdate();
	       output = "Inserimento avvenuto con successo!";
       }
